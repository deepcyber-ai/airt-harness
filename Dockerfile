...
# Vendored ai_models package (the harness imports it) and the model catalogue.
# Profiles reference ../../models.yaml, which resolves to /app/models.yaml here.
# (Present in the public export; a WIP-native build must vendor them first.)
